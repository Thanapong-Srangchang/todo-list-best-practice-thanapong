...
var _todo = require("../../../dist/modules/todo/todo.controller");
var _todo2 = require("../../models/todo.model");
...
function createTodo(TodoData) {
  var newTodo = new _todo2.TodoModel(TodoData);
  return newTodo.save();
}
function updateTodoById(id, todoData) {
  return _todo2.TodoModel.findByIdAndUpdate(id, todoData);
}
function deleteTodoById(id) {
  return _todo2.TodoModel.findByIdAndDelete(id);
}
;
function findTodoById(id) {
  return _todo2.TodoModel.findById(id);
}
function findManyTodoList(query) {
  ...
  return _todo2.TodoModel.find(baseQuery);
}